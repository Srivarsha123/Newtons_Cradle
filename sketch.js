...
World.add(world, mConstraint);
   ...
   pendulum1 = new Pendulum(340, 460, "#B20F0F");
   pendulum2 = new Pendulum(400, 460, "#EC7D71");
   pendulum3 = new Pendulum(460, 460, "#9FB64A");
   pendulum4 = new Pendulum(520, 460, "#5DB4C6"); 
   pendulum5 = new Pendulum(580, 460, "#AB46CB");
